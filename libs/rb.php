...
class Facade
{
	 ...
	 * try to create a SQLite database in /tmp called red.libs (this only works on UNIX-like systems).
	 *
	 * Usage:
	 *
	 * <code>
	...
	{
		if ( is_null( $dsn ) ) {
			$dsn = 'sqlite:' . DIRECTORY_SEPARATOR . sys_get_temp_dir() . DIRECTORY_SEPARATOR . 'red.libs';
		}
   ...
   * /tmp called red.libs (this only works on UNIX-like systems).
	 *
	 * Usage:
	 *
	 * <code>
